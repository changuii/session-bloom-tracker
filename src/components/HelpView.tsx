  ...
  return (
    <Card className="border-2 border-red-200 bg-white">
      <CardContent className="p-8 space-y-8">
        ...
        <h1 className="text-4xl font-bold text-red-800 font-handwriting">
          🍅 회고 토마토 타이머 사용법
        </h1>
          ...
          <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-3 gap-4 mt-6">
              <Card className="bg-white border-red-200">
                <CardContent className="p-4 text-center">
                  ...
                  <h4 className="font-semibold text-red-800 mb-2">포모도로의 의미</h4>
              ...
              <Card className="bg-white border-orange-200">
                <CardContent className="p-4 text-center">
                  <div className="text-3xl mb-2">⏰</div>
                  <h4 className="font-semibold text-orange-800 mb-2">과학적 시간 관리</h4>
                  <p className="text-sm text-gray-600">
              ...
              <Card className="bg-white border-green-200">
                <CardContent className="p-4 text-center">
                  <div className="text-3xl mb-2">🧠</div>
                  <h4 className="font-semibold text-green-800 mb-2">뇌과학적 효과</h4>
                  <p className="text-sm text-gray-600">
            ...
            <div className="mt-6 p-4 bg-yellow-50 rounded-lg border-l-4 border-yellow-400">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-semibold text-yellow-800 mb-2">왜 25분일까요?</h4>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {howToUse.map((step, index) => (
            <Card key={index} className="relative overflow-hidden">
              <div className="absolute top-4 right-4 w-8 h-8 bg-red-500 text-white rounded-full flex items-center justify-center font-bold text-sm">
                {step.step}
              </div>
              <CardHeader className="pb-3">
      ...
      {/* 시작하기 CTA */}
      <div className="text-center space-y-4 bg-gradient-to-r from-red-50 to-orange-50 p-8 rounded-2xl border-2 border-red-200">
      ...
      <div className="space-y-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">데이터는 어디에 저장되나요?</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">AI 피드백은 어떻게 받나요?</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-600">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">타이머 시간을 조정할 수 있나요?</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-600">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">알림이 안 와요</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-600">
