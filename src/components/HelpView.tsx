      ...
      <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
        ...
        <SheetContent side="bottom" className="h-[85vh] py-6 px-4">
          <SheetHeader className="mb-4">
            <SheetTitle className="text-xl text-red-800 flex items-center gap-2">
              🍅 사용법 안내
            </SheetTitle>
          </SheetHeader>
          ...
          <div className="overflow-y-auto h-full pb-20 space-y-4">
            ...
            <div className="space-y-3">
              <h3 className="text-lg font-semibold text-red-800 border-b border-red-200 pb-1">
                🚀 빠른 시작
              </h3>
              
              <div className="space-y-2">
                <div className="bg-red-50 p-3 rounded-lg border border-red-200">
                  <h4 className="font-medium text-red-800 mb-1 flex items-center gap-1 text-sm">
                    🎯 1. 타이머 시작
                  </h4>
                  <p className="text-xs text-red-700 mb-2">25분 집중 타이머를 시작하세요</p>
                  <Button 
                    onClick={() => handleQuickStart('timer')} 
                    className="w-full bg-red-600 hover:bg-red-700 text-white text-xs py-1.5"
                  >
                    바로가기 →
                  </Button>
                </div>
                ...
                <div className="bg-orange-50 p-3 rounded-lg border border-orange-200">
                  <h4 className="font-medium text-orange-800 mb-1 flex items-center gap-1 text-sm">
                    ⚙️ 2. 설정 조정
                  </h4>
                  <p className="text-xs text-orange-700 mb-2">시간과 알림을 설정하세요</p>
                  <Button 
                    onClick={() => handleQuickStart('settings')} 
                ...
                <div className="bg-yellow-50 p-3 rounded-lg border border-yellow-200">
                  ...
                  <p className="text-xs text-yellow-700 mb-2">AI 피드백을 받아보세요</p>
                  <Button 
                    onClick={() => handleQuickStart('reflection')} 
                    className="w-full bg-yellow-600 hover:bg-yellow-700 text-white text-xs py-1.5"
                  >
                    바로가기 →
                  </Button>
                </div>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                <div className="flex items-start gap-2 bg-white p-2 rounded border">
                  ...
                  <div>
                    <p className="font-medium text-red-800 text-xs">포모도로 타이머</p>
                    <p className="text-xs text-red-600">25분 집중 + 5분 휴식</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2 bg-white p-2 rounded border">
                  <span className="text-sm">📝</span>
                  <div>
                    <p className="font-medium text-red-800 text-xs">AI 회고 피드백</p>
                    <p className="text-xs text-red-600">개인화된 피드백 제공</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2 bg-white p-2 rounded border">
                  <span className="text-sm">📊</span>
                  <div>
                    <p className="font-medium text-red-800 text-xs">상세한 통계</p>
                    <p className="text-xs text-red-600">집중 패턴 분석</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2 bg-white p-2 rounded border">
                  <span className="text-sm">🔔</span>
                  <div>
                    <p className="font-medium text-red-800 text-xs">브라우저 알림</p>
                    <p className="text-xs text-red-600">세션 완료 시 알림</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                <div className="flex items-start gap-2 bg-white p-2 rounded border">
                  <span className="text-sm">⏰</span>
                  <div>
                    <p className="font-medium text-red-800 text-xs">시간 설정</p>
                    <p className="text-xs text-red-600">집중/휴식 시간 조정</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2 bg-white p-2 rounded border">
                  <span className="text-sm">🔔</span>
                  <div>
                    <p className="font-medium text-red-800 text-xs">알림 설정</p>
                    <p className="text-xs text-red-600">소리/브라우저 알림</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2 bg-white p-2 rounded border">
                  <span className="text-sm">🤖</span>
                  <div>
                    <p className="font-medium text-red-800 text-xs">AI 설정</p>
                    <p className="text-xs text-red-600">Gemini API 키 입력</p>
                  </div>
                </div>
              </div>
            </div>
